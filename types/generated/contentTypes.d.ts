...
export interface ApiAutorAutor extends Schema.CollectionType {
  ...
  attributes: {
    fio: Attribute.Text & Attribute.Required;
    dateRog: Attribute.Date;
    img: Attribute.Media & Attribute.Required;
    descr: Attribute.Text & Attribute.Required;
...
export interface ApiPicturePicture extends Schema.CollectionType {
  ...
  attributes: {
    ...
    name: Attribute.String & Attribute.Required;
    descr: Attribute.Text & Attribute.Required;
    dateCreate: Attribute.Date & Attribute.Required;
    autor_id: Attribute.Relation<
      'api::picture.picture',
      'manyToOne',
      'api::autor.autor'
    >;
    Country: Attribute.String;
    reviews_ids: Attribute.Relation<
      'api::picture.picture',
      'oneToMany',
      'api::review.review'
    >;
